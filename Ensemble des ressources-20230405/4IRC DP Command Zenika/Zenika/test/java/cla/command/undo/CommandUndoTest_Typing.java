 ...
 * On propose ici trois variations du pattern, plus ou moins adaptées selon le type de commande:
 ...
 Memento: lors de chaque exécution de commande, on mémorise l’état du système; 
 annuler une commande consiste alors à revenir à l’état précédent
 Replay: pour annuler la dernière commande, on commence par repositionner le système dans l’état initial (reset), 
 puis on ré-exécute toutes les commandes sauf la dernière
 
 Pour s’assurer que les 3 variations sont fonctionnellement équivalentes, on écrit les tests dans cette classe abstraite.  
 Les classes concrètes spécifiques aux 3 variations ne font qu’instancier un type différent de Conversation 
 (à un détail technique près,  propre aux génériques java) : CommandUndoTest_Compensation_Typing_Test, 
 CommandUndoTest_Replay_Typing_Test, CommandUndoTest_Memento_Typing_Test
 
 Les tests commencent par les cas triviaux et vont jusqu’à une conversation complexe
 */
