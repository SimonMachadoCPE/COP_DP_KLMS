...
public class PieceModelFactory {
	...
	enum ChessPiecePos {
		...
		//PIONBLANC("model/noStrategy/pieces/Pion", PieceSquareColor.WHITE, new ModelCoord[] {new ModelCoord('a',2), new ModelCoord('b',2), new ModelCoord('c',2), new ModelCoord('d',2),
		//		new ModelCoord('e',2), new ModelCoord('f',2), new ModelCoord('g',2), new ModelCoord('h',2)}),
		PIONBLANC("templateMethod.PionBlanc", PieceSquareColor.WHITE, new ModelCoord[] {new ModelCoord('a',2), new ModelCoord('b',2), new ModelCoord('c',2), new ModelCoord('d',2),
				new ModelCoord('e',2), new ModelCoord('f',2), new ModelCoord('g',2), new ModelCoord('h',2)}),
		...
		//PIONNOIR("model/noStrategy/pieces/Pion", PieceSquareColor.BLACK, new ModelCoord[] {new ModelCoord('a',7), new ModelCoord('b',7), new ModelCoord('c',7), new ModelCoord('d',7),
		//		new ModelCoord('e',7), new ModelCoord('f',7), new ModelCoord('g',7), new ModelCoord('h',7)})
		PIONNOIR("templateMethod.PionNoir", PieceSquareColor.BLACK, new ModelCoord[] {new ModelCoord('a',7), new ModelCoord('b',7), new ModelCoord('c',7), new ModelCoord('d',7),
				new ModelCoord('e',7), new ModelCoord('f',7), new ModelCoord('g',7), new ModelCoord('h',7)})
		; 
